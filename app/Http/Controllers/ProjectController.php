...
class ProjectController extends \TCG\Voyager\Http\Controllers\Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $duration = (\request("duration"))?abs(\request("duration")):1;
        $duration_unit = Project::getUnit(\request("duration_unit"));
    ...
    public function finish(Request $request, $id)
    {
        ...
        $project->update(['status' => 3,'finished_at' => Carbon::now()->toDateTimeString()]);
        return redirect()->back()->with([
            'message'    => "تم اتمام المشروع بنجاح",
            'alert-type' => 'success',
        ]);
    }
    ...
    {
        $project = Project::find($id);
        $project->update(['status' => 4,'canceled_at' => Carbon::now()->toDateTimeString()]);
        return redirect()->back()->with([
            'message'    => "تم إلغاء المشروع ",
            'alert-type' => 'error',
        ]);
    }
    public function quantity_approved(Request $request, $id)
    {
        $project = Project::find($id);
        $project->update(['quantity_approved' => 1]);
        return redirect()->route("voyager.projects.index")->with([
            'message'    => "تم اعتماد جدول الكميات المشروع ",
            'alert-type' => 'success',
        ]);
    }
    //***************************************
