...
class QuantityController extends \TCG\Voyager\Http\Controllers\Controller
{
    ...
    {
        $slug = $this->getSlug($request);
        $request->merge(['total_price' => \request("individual_price") * \request("quantity")]);
        $dataType = Voyager::model('DataType')->where('slug', '=', $slug)->first();
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','project_id'));
    }
