...
return [
    ...
    */
    ...
    'googlemaps' => [
        'key'    => env('GOOGLE_MAPS_KEY', 'AIzaSyDzFcX_nHqkMomC6ajs5RSuvDY4vuAn62s'),
        'center' => [
            'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '35.9266549'),
            'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '36.653078'),
        ],
