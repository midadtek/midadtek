...
<!-- 		
		...
		<table style="width: 100%; margin-left: auto; margin-right: auto;" class="borderdtable">
			...
			<tbody>
				...
				<tr>
					...
					<td style=" text-align: center;">{{ $project->finished_at ? $project->finished_at}}</td>

					<td style=" text-align: center;">{{$project->price ? $project->price:'-------'}}</td>
		...
		<table style="width: 100%; margin-left: auto; margin-right: auto;margin-top:50px" class="borderdtable">
			<thead>
				...
				<th style="width: 20%; text-align: center;"><strong> قيمة اجمالي المشاريع  </strong></th>

				<th style="width: 20%; text-align: center;"><strong> عدد المشاريع </strong></th>
			...
			<tbody>
				...
				<td style="width: 15%; text-align: center;">  {{$project_sum ? $project_sum:'-------'}}</td>

					<td style="width: 15%; text-align: center;">  {{$projects ? count($projects):'-------'}}</td>
