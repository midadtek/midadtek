...
@section('page_header')
<h1 class="page-title">
    {{ ($edit) ? 'تعديل محضر الصرف  ' : 'إضافة محضر صرف  ' }} <span style="color: red">{{' '.$project->title}}</span>
</h1>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row items">
                            ...
                            <div class="col-md-12 item_added">
                                ...
                                <div class="form-group  col-md-2">
                                    <select class="form-control select2" name="stage_id[]"  required>
                                        <option value="" data-unit="">--</option>
                                        @foreach ($stages as $stage)
                                        <option value="{{$stage->id}}" @if ($stage->id==$item->stage_id)
                                            selected
                                            @endif>{{$stage->title}}
                                        </option>
                                        @endforeach
...
<div class="item_element" style="display: none">
    ...
    <div class="form-group  col-md-2">
        <select class="form-control new-select" name="stage_id[]"  required>
            <option value="" data-unit="">--</option>
            @foreach ($stages as $stage)
            <option value="{{$stage->id}}">{{$stage->title}}</option>
            @endforeach
